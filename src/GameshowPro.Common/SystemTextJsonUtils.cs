...
[RequiresUnreferencedCode("SystemTextJsonUtils uses runtime JSON metadata resolution for dynamic scenarios.")]
[RequiresDynamicCode("SystemTextJsonUtils uses runtime JSON metadata resolution for dynamic scenarios.")]
public static class SystemTextJsonUtils
{
    ...
    /// <param name="cancellationToken">Optional cancellation token.</param>
    /// <remarks>Docs added by AI.</remarks>
    [RequiresUnreferencedCode("JSON deserialization can require reflective metadata for runtime types.")]
    [RequiresDynamicCode("JSON deserialization can require runtime-generated metadata for runtime types.")]
    ...
    public static async Task<T?> Depersist<T>(Stream stream, JsonTypeInfo<T> jsonTypeInfo, CancellationToken? cancellationToken)
        => await JsonSerializer.DeserializeAsync(stream, jsonTypeInfo, cancellationToken ?? default);
    ...
    /// <param name="cancellationToken">Optional cancellation token.</param>
    /// <remarks>Docs added by AI.</remarks>
    [RequiresUnreferencedCode("JSON serialization can require reflective metadata for runtime types.")]
    [RequiresDynamicCode("JSON serialization can require runtime-generated metadata for runtime types.")]
    public static async Task Persist<T>(T obj, string? path, JsonSerializerOptions? jsonSerializerOptions, ILogger? logger, CancellationToken? cancellationToken)
    {
        ...
        try
        {
            ...
            {
                await Persist(obj, fileStream, jsonSerializerOptions, cancellationToken);
                await fileStream.FlushAsync(cancellationToken ?? default);
            }
    ...
    public static async Task Persist<T>(T obj, Stream stream, JsonTypeInfo<T> jsonTypeInfo, CancellationToken? cancellationToken)
        => await JsonSerializer.SerializeAsync(stream, obj, jsonTypeInfo, cancellationToken ?? default);
